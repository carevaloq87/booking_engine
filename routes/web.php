...
Route::get('/', 'DashboardController@home')->name('welcome');

Auth::routes();
Route::get('/logout', '\App\Http\Controllers\Auth\LoginController@logout')->name('logout');
Route::match(['get', 'post'], '/login_vla', 'AuthController@loginVLA')->name('login_VLA');
Route::match(['get'], '/login_clc/{user_details}', 'AuthController@loginCLC');
Route::post('/service_provider/set_sp', 'HomeController@setServiceProvider')
            ->name('home.service_provider.set');
