...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(34), __webpack_require__(103).setImmediate))
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dragselect__ = __webpack_require__(376);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dragselect___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_dragselect__);
...
var SelectableDS = function () {
    /**
     * Initialize Object Selectable
     */
    function SelectableDS(ds_class) {
        _classCallCheck(this, SelectableDS);

        this.selectable = new __WEBPACK_IMPORTED_MODULE_0_dragselect___default.a({
    ...
    _createClass(SelectableDS, [{
        key: 'setInitialSelections',
        ...
        value: function submit() {
            console.log('Selection:' + this.selectable.getSelection().map(function (item) {
                return item.id;
            }));
            console.log('Selection:' + this.selectable.getSelection().map(function (item) {
                return item.id;
...
/* harmony default export */ __webpack_exports__["a"] = (SelectableDS);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bootstrap_dist_css_bootstrap_min_css__ = __webpack_require__(160);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_polyfill__ = __webpack_require__(170);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_axios__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_form__ = __webpack_require__(372);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_uiv__ = __webpack_require__(374);
...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_5_uiv__);
...
window.Form = __WEBPACK_IMPORTED_MODULE_4__utils_form__["a" /* default */];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__errors__ = __webpack_require__(373);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Form = function () {
    ...
    _createClass(Form, [{
        ...
        value: function data() {
            var data = {};
            for (var propety in this.originalData) {
...
Component.options.__file = "resources\\assets\\js\\components\\booking_engine\\days\\calendar_container.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6c6f49f0", Component.options)
  } else {
    hotAPI.reload("data-v-6c6f49f0", Component.options)
  }
...
var render = function() {
  ...
  return _c("table", { class: _vm.tableClass }, [
    _vm._m(0),
    _vm._v(" "),
    _c(
      "tbody",
      _vm._l(_vm.currentCalendar, function(calendar, month) {
        return _c(
          "tr",
          { key: month, staticClass: "month" },
          [
            _c("td", {
              staticClass: "month_label",
              domProps: { textContent: _vm._s(month) }
            }),
            _vm._v(" "),
            _vm._l(calendar, function(day_number, day) {
              return _c("td", { key: day, staticClass: "week_day" }, [
                day_number !== ""
                  ? _c("span", {
                  ...
                  : _vm._e(),
                _vm._v(" "),
                day_number === "" ? _c("span", [_vm._v(" ")]) : _vm._e()
              ])
            })
          ],
          2
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6c6f49f0", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\booking_engine\\hours\\hours_container.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-09a6ce67", Component.options)
  } else {
    hotAPI.reload("data-v-09a6ce67", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        drawHours: function drawHours(week_day, hour) {
            var self = this;
            var current_time_structure = self.time_structure[self.time_structure_active];
            var standard_container = '';

            var initial_minute = current_time_structure.el_in_col * (hour - 1);
            ...
            for (var index = 0; index < current_time_structure.el_in_col; index++) {
                ...
                var btn = '<button type="button" class="btn ds-button ' + self.time_structure_active + '" id="' + week_day + '-' + element_id + '">&nbsp;</button>';
...
var render = function() {
  ...
  return _c("div", { class: _vm.tableClass }, [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "form-group margin-top-10 hours_selection" }, [
      _c(
        "div",
        ...
        [
          _vm._m(1),
          _vm._v(" "),
          _vm._l(_vm.week_days, function(day, id) {
            return _c("div", { key: id }, [
              _c(
                ...
                [
                  _c("div", {
                    staticClass: "day_col noSelect",
                    domProps: { textContent: _vm._s(day) }
                  }),
                  _vm._v(" "),
                  _vm._l(24, function(n, i) {
                    return _c("div", { key: i, staticClass: "hours_col" }, [
                      _c("div", {
                        domProps: { innerHTML: _vm._s(_vm.drawHours(day, n)) }
                      })
                    ])
                  })
                ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-09a6ce67", module.exports)
  }
}
...
Vue.component('resource-days', __webpack_require__(528));
Vue.component('resource-hours', __webpack_require__(531));
...
Component.options.__file = "resources\\assets\\js\\components\\booking_engine\\days\\resource_days.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-dab01a60", Component.options)
  } else {
    hotAPI.reload("data-v-dab01a60", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectableDS__ = __webpack_require__(158);
//
//
//
//
...
Vue.component('calendar-container', __webpack_require__(378));
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['resource'],
    data: function data() {
        return {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "resource_days" }, [
    _c(
      "div",
      {
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.isActiveTab("currentActive"),
            expression: "isActiveTab('currentActive')"
          }
        ],
        attrs: { id: "current" }
      },
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.isActiveTab("nextActive"),
            expression: "isActiveTab('nextActive')"
          }
        ],
        attrs: { id: "next" }
      },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-dab01a60", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\booking_engine\\hours\\resource_hours.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b5cc3b10", Component.options)
  } else {
    hotAPI.reload("data-v-b5cc3b10", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Vue.component('hours-container', __webpack_require__(381));
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['resource'],
    data: function data() {
        return {
    ...
    methods: {
        ...
        submitInfo: function submitInfo() {
            ...
            var url = '/calendar/resource/hours';

            $("#contentLoading").modal("show");
            axios['post'](url, { id: self.resource, hours: hours }).then(function (response) {
                console.log(response);
            }).then(function () {
                $("#contentLoading").modal("hide");
            }).catch(function (error) {
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("div", { staticClass: "tab-content col-xs-12" }, [
      _c(
        "div",
        { staticClass: "tab-pane fade in active", attrs: { id: "regular" } },
        [
          _c("hours-container", {
            attrs: {
    ...
    _vm._v(" "),
    _c("div", { staticClass: "form-group margin-top-10" }, [
      _c("div", { staticClass: "col-sm-12 margin-top-10" }, [
        _c(
          "button",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-b5cc3b10", module.exports)
  }
}
