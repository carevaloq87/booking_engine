	...
	$.fn[pluginName] = function (options) {
		...
		var Plugin = {
			...
			setupSystemColumn: function () {
					...
					$(tr).find('.' + pfx + 'datatable__cell').each(function (tdi, td) {
						...
						if (typeof column !== 'undefined') {
							...
							if (typeof column.selector !== 'undefined' && column.selector !== false) {
								...
								// append checkbox
								var chk = $('<label/>').addClass(pfx + 'checkbox ' + pfx + 'checkbox--single')
              ...
              // append checkbox
              var chk = $('<label/>').addClass(pfx + 'checkbox ' + pfx + 'checkbox--single ' + pfx + 'checkbox--all')
			...
			setActiveAll: function (active) {
				...
				var checkboxes = $(datatable.table).find('> tbody, > thead').find('> tr:not(.m-datatable__row-subtable)').find('.' + pfx + 'datatable__cell--check [type="checkbox"]');
				if (active) {
