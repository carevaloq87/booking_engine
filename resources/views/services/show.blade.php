                            ...
                            <div class="row border-bottom mb-4 pb-4">
                                ...
                                <div class="col-sm-12 col-lg-3">
                                    <div class="col-sm-12 text-left">
                                        <p>General service availability is defined by days and hours of operation for both standard and interpreter/complex appointments.</p>
                                        <p>For specific days when you need to make an exception to general availability (office closures, training sessions, etc.) you can also set exceptions and ad hoc settings.</p>
                                        <p>Setting the service display colour changes the way your service appears here and in Orbit.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row border-bottom mb-4 pb-4">
