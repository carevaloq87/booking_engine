...
@section('content')
    <div class="container service_page" id="booking_engine">
        ...
        <div class="m-accordion m-accordion--default m-accordion--solid m-accordion--toggle-arrow" id="accordion_service" role="tablist">
            ...
            <div class="m-accordion__item">
                <div class="m-accordion__item-head" role="tab" id="accordion_service_details" data-toggle="collapse" href="#accordion_service_details_body" aria-expanded="false" data-tooltip="true" data-placement="top" title="Click to open or close Service Details" v-on:click="goToAccordion">
            ...
            <!--begin::Item-->
            <div class="m-accordion__item">
                <div class="m-accordion__item-head collapsed" role="tab" id="accordion_service_availability" data-toggle="collapse" href="#accordion_service_availability_body" aria-expanded="false" data-tooltip="true" data-placement="top" title="Click to open or close Service Availability" v-on:click="goToAccordion">
