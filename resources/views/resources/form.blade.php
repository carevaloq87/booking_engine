...
<div class="d-inline-flex align-items-center p-2 {{ $errors->has('name') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="name" type="text" id="name" value="{{ old('name', optional($resource)->name) }}" maxlength="100" required placeholder="Enter name here...">
...
<div class="d-inline-flex align-items-center p-2 {{ $errors->has('phone') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="phone" type="text" id="phone" value="{{ old('phone', optional($resource)->phone) }}" maxlength="13" placeholder="Enter phone here...">
...
<div class="d-inline-flex align-items-center p-2 {{ $errors->has('email') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="email" type="email" id="email" value="{{ old('email', optional($resource)->email) }}" maxlength="75" placeholder="Enter email here...">
